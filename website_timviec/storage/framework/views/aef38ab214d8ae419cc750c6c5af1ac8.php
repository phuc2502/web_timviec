<?php $__env->startSection('title', 'Chọn loại tài khoản'); ?>
...
<div style="min-height:calc(100vh - 60px);display:flex;align-items:center;background:linear-gradient(135deg,#f0fdf7 0%,#e8f4fd 100%);padding:40px 16px">
  <div style="width:100%;max-width:640px;margin:0 auto">
    ...
    <div class="grid-2" style="gap:20px">
      ...
      <a href="<?php echo e(url('/register/employee')); ?>" class="card" style="padding:32px 24px;text-align:center;transition:var(--transition);display:block;text-decoration:none" onmouseover="this.style.borderColor='var(--primary)';this.style.transform='translateY(-4px)';this.style.boxShadow='var(--shadow-lg)'" onmouseout="this.style.borderColor='var(--border)';this.style.transform='';this.style.boxShadow='var(--shadow-sm)'">
      ...
      <a href="<?php echo e(url('/register/employer')); ?>" class="card" style="padding:32px 24px;text-align:center;transition:var(--transition);display:block;text-decoration:none" onmouseover="this.style.borderColor='var(--primary)';this.style.transform='translateY(-4px)';this.style.boxShadow='var(--shadow-lg)'" onmouseout="this.style.borderColor='var(--border)';this.style.transform='';this.style.boxShadow='var(--shadow-sm)'">
    ...
    <p class="text-center text-muted fs-13 mt-24">
      Đã có tài khoản? <a href="<?php echo e(url('/login')); ?>" class="text-primary-color fw-600">Đăng nhập</a>
    </p>
  </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\web_timviec_fixed\web_timviec_fixed\website_timviec\resources\views/user/register.blade.php ENDPATH**/ ?>