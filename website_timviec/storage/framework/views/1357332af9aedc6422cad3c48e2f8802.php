...
<?php if(auth()->user()->user_trial && auth()->user()->user_trial > now() && !auth()->user()->billing_ends): ?>
  <div class="alert alert-warning mb-16">
    ...
    <span>Bạn đang dùng thử miễn phí gói Doanh nghiệp — còn <strong><?php echo e(now()->diffInDays(auth()->user()->user_trial)); ?> ngày</strong>. <a href="<?php echo e(url('/subscribe')); ?>" class="fw-700" style="color:inherit;text-decoration:underline">Nâng cấp Premium ngay</a> để nhận đầy đủ quyền lợi.</span>
  </div>
<?php endif; ?>
    ...
    <div class="card" style="background:linear-gradient(135deg, var(--secondary), #2c3e50);color:#fff; border-radius: var(--radius-lg);">
      <div class="card-body" style="padding:20px">
        ...
        <?php else: ?>
          ...
          <a href="<?php echo e(url('/subscribe')); ?>" class="btn btn-sm mt-12" style="background:var(--primary);color:#fff; width:100%; justify-content:center;">Nâng cấp gói ngay</a>
        <?php endif; ?>
      </div>
    </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\web_timviec_final\website_timviec\resources\views/dashboard.blade.php ENDPATH**/ ?>