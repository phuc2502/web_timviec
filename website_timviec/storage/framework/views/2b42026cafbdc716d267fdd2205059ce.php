...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
              ...
              <input type="date" name="application_close_date" class="form-control <?php echo e($errors->has('application_close_date') ? 'is-invalid' : ''); ?>"
                value="<?php echo e(old('application_close_date')); ?>" min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>" required>
              <?php $__errorArgs = ['application_close_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\web_timviec_fixed\web_timviec_fixed\website_timviec\resources\views/job/create.blade.php ENDPATH**/ ?>