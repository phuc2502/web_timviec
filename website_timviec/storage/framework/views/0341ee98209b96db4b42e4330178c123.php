<?php $__env->startSection('title', 'Đăng ký Ứng viên — ITWorks'); ?>
  ...
  <div class="auth-container" style="max-width:480px">
    ...
    <div class="card auth-card">
      <div class="card-body" style="padding:28px">
        ...
        <form action="<?php echo e(route('register.employee.submit')); ?>" method="POST" id="register-form">
          <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:4px">
              <a href="<?php echo e(route('auth.google.register', 'employee')); ?>" class="btn btn-google" style="justify-content:center">
              ...
              <a href="<?php echo e(route('auth.github.register', 'employee')); ?>" class="btn" style="
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\dl\website_timviec_v15 (1)\website_timviec_v15 (1)\website_modified\resources\views/auth/register-employee.blade.php ENDPATH**/ ?>