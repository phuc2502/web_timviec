...
<div class="apply-wrap">
  ...
  <div class="flex gap-6 mb-16" style="align-items:center;font-size:12px;color:var(--text-secondary)">
    <a href="<?php echo e(url('/job')); ?>" style="color:var(--text-secondary);text-decoration:none">Tìm việc</a>
    <i class="fas fa-chevron-right" style="font-size:9px;opacity:.5"></i>
    <a href="<?php echo e(url('/job/show/'.$listing->slug)); ?>" style="color:var(--text-secondary);text-decoration:none;max-width:180px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap"><?php echo e($listing->title); ?></a>
    <i class="fas fa-chevron-right" style="font-size:9px;opacity:.5"></i>
  ...
  <div class="apply-job-card">
    <div class="apply-job-logo">
      <?php if($listing->feature_image): ?>
        <img src="<?php echo e(asset('storage/images/'.$listing->feature_image)); ?>" style="width:40px;height:40px;object-fit:contain">
      <?php else: ?>
        <i class="fas fa-building" style="color:var(--primary);font-size:20px"></i>
      <?php endif; ?>
    </div>
    <div style="flex:1;min-width:0">
      <div class="fw-700" style="font-size:16px;color:var(--secondary)"><?php echo e($listing->title); ?></div>
      <div class="fs-13 text-muted mt-4">
        <?php echo e($listing->user->company_name ?? $listing->user->name); ?>

        <span style="margin:0 6px;opacity:.4">·</span>
        <i class="fas fa-map-marker-alt fa-fw" style="font-size:11px"></i> <?php echo e($listing->address); ?>

        <span style="margin:0 6px;opacity:.4">·</span>
        <i class="fas fa-clock fa-fw" style="font-size:11px"></i> <?php echo e($listing->job_type); ?>

      </div>
    </div>
    <a href="<?php echo e(url('/job/show/'.$listing->slug)); ?>" class="btn btn-outline btn-sm" style="flex-shrink:0">
      <i class="fas fa-arrow-left fa-fw"></i> Quay lại
    </a>
  </div>

  
  <div class="apply-token-bar <?php echo e($balance > 0 ? 'ok' : 'empty'); ?>">
    <div class="flex gap-12" style="align-items:center">
      <div style="width:38px;height:38px;border-radius:50%;background:<?php echo e($balance > 0 ? 'var(--primary)' : 'var(--danger)'); ?>;display:flex;align-items:center;justify-content:center;flex-shrink:0">
        <i class="fas fa-ticket-alt" style="color:#fff;font-size:15px"></i>
      </div>
      <div>
        <div class="fw-700 fs-14" style="color:<?php echo e($balance > 0 ? 'var(--primary-dark)' : 'var(--danger)'); ?>">
        ...
        <div class="fs-12" style="color:<?php echo e($balance > 0 ? 'var(--text-secondary)' : 'var(--danger)'); ?>;margin-top:2px">
          <?php echo e($balance > 0 ? 'Ứng tuyển sẽ trừ 1 lượt từ tài khoản của bạn' : 'Hết lượt — mua thêm để tiếp tục nộp đơn'); ?>

        </div>
      </div>
    </div>
    <?php if($balance === 0): ?>
      <a href="<?php echo e(route('payment.token')); ?>" class="btn btn-sm" style="background:var(--danger);color:#fff;flex-shrink:0">
        <i class="fas fa-plus fa-fw"></i> Mua ngay
      </a>
    <?php else: ?>
      <a href="<?php echo e(route('payment.token')); ?>" class="btn btn-outline btn-sm" style="border-color:var(--primary);color:var(--primary);flex-shrink:0">
  ...
  <div class="apply-card">
    ...
    <div class="apply-card-body">
      <form action="<?php echo e(route('apply.submit')); ?>" method="POST" enctype="multipart/form-data" id="apply-form">
        <?php echo csrf_field(); ?>
            ...
            <div class="cv-option selected" id="opt-existing" onclick="selectCvOption('existing')">
              <label style="cursor:pointer;display:flex;align-items:center;gap:12px;margin:0">
                ...
                <div style="flex:1">
                  ...
                  <div class="fs-12 text-muted mt-4"><?php echo e($suggestedCv->original_name); ?></div>
                </div>
              </label>
...
$message = $__bag->first($__errorArgs[0]); ?> <div class="text-danger fs-12 mt-8"><i class="fas fa-exclamation-circle fa-fw"></i> <?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="margin-bottom:24px">
          ...
          <textarea name="cover_letter" class="apply-textarea"
            ...
            maxlength="3000"><?php echo e(old('cover_letter')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="margin-bottom:24px">
          ...
          <div class="apply-checkbox-row">
            <input type="checkbox" name="is_agreed_terms" id="terms-cb" value="1" <?php echo e(old('is_agreed_terms') ? 'checked' : ''); ?>>
            <label for="terms-cb" class="fs-13" style="cursor:pointer;color:var(--text-body);line-height:1.5">
              ...
              <a href="#" style="color:var(--primary)">Chính sách bảo mật</a> của <?php echo e(config('app.name')); ?>.
...
unset($__errorArgs, $__bag); ?>
        ...
        <button type="submit" id="submit-btn"
          class="apply-submit <?php echo e($balance > 0 ? 'active' : 'disabled'); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\web_timviec_fixed\web_timviec_fixed\website_timviec\resources\views/application/form.blade.php ENDPATH**/ ?>