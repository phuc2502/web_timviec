                ...
                <?php if($existingApplication): ?>
                  ...
                  <div>
                    ...
                    <div class="fs-12 text-muted mt-8" style="text-align:center">
                      ...
                      Đã nộp ngày <?php echo e($existingApplication->applied_at->format('d/m/Y')); ?>
                      ...
                      ?>
                      <span style="color:<?php echo e($sc[$existingApplication->status] ?? 'var(--text-secondary)'); ?>;font-weight:600"><?php echo e($sl); ?></span>
                    </div>
                  </div>
                <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\web_timviec_final\website_timviec\resources\views/job/show.blade.php ENDPATH**/ ?>