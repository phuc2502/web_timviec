<?php $__env->startSection('title', 'Mua lượt ứng tuyển'); ?>
...
<div class="container section" style="max-width:860px">
  ...
  <div style="display:inline-flex;align-items:center;gap:10px;background:#e0f2fe;border:1.5px solid #38bdf8;border-radius:10px;padding:12px 20px;margin-bottom:24px">
    ...
    <span style="font-size:14px;color:#0c4a6e">
      ...
      <strong style="color:#0369a1;margin-left:4px"><?php echo e($balance); ?> lượt</strong>
    </span>
  </div>
  ...
  <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:20px">
    ...
    ?>
    <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amount => $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div style="border:2px solid <?php echo e($colors[$amount]); ?>;border-radius:var(--radius-xl);overflow:hidden;background:#fff;box-shadow:var(--shadow-md);transition:var(--transition);position:relative"
        ...
        <div style="padding:24px;text-align:center">
          <div style="font-size:40px;margin-bottom:12px"><?php echo e($icons[$amount]); ?></div>
          <div class="fw-700" style="font-size:20px;color:var(--secondary)"><?php echo e($amount); ?> lượt</div>
          <div class="fw-700" style="font-size:28px;color:var(--primary);margin:8px 0">
            <?php echo e(number_format($price)); ?><span style="font-size:14px;font-weight:500;color:var(--text-secondary)">đ</span>
          </div>
          <div class="text-muted fs-12 mb-16">≈ <?php echo e(number_format($price / $amount)); ?>đ / lượt</div>

          <form action="<?php echo e(route('payment.token.initiate')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="package" value="<?php echo e($amount); ?>">
            <button type="submit" class="btn <?php echo e($amount === 10 ? 'btn-primary' : 'btn-outline'); ?> btn-block">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\web_timviec_fixed\web_timviec_fixed\web_timviec_fixed\website_timviec\resources\views/payment/token.blade.php ENDPATH**/ ?>