...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:4px">
              <a href="<?php echo e(route('auth.google')); ?>" class="btn btn-google" style="justify-content:center">
              ...
              <a href="<?php echo e(route('auth.github')); ?>" class="btn" style="
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\dl\website_timviec_v13_social_verified\website_output\resources\views/auth/register-employee.blade.php ENDPATH**/ ?>