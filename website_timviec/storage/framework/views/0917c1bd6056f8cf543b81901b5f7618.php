<?php $__env->startSection('title', 'Thiết kế CV Online'); ?>
...
<div class="flex-between mb-20">
  ...
  <a href="<?php echo e(route('user.cv')); ?>" class="btn btn-outline btn-sm"><i class="fas fa-arrow-left"></i> Quay lại</a>
</div>

<form action="<?php echo e(route('user.cv.save')); ?>" method="POST" enctype="multipart/form-data" id="cv-form" class="flex-col gap-20">
  <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                     value="<?php echo e(old('full_name', $cvData->full_name ?? auth()->user()->name)); ?>" required placeholder="Nguyễn Văn A">
              <?php $__errorArgs = ['full_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                <div class="invalid-feedback" style="color:var(--danger); font-size:11px; margin-top:4px;"><?php echo e($message); ?></div>
              <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
unset($__errorArgs, $__bag); ?>" 
                     value="<?php echo e(old('email', $cvData->email ?? auth()->user()->email)); ?>" required placeholder="nguyenvana@gmail.com">
...
unset($__errorArgs, $__bag); ?>" 
                     value="<?php echo e(old('phone', $cvData->phone ?? '')); ?>" placeholder="0901234567">
...
unset($__errorArgs, $__bag); ?>" 
                     value="<?php echo e(old('address', $cvData->address ?? '')); ?>" placeholder="Quận 1, TP. Hồ Chí Minh">
          ...
          <div class="grid gap-16 mb-16" style="grid-template-columns: 1fr 2fr;">
            <div class="form-group">
              ...
              <div style="width: 80px; height: 80px; border-radius: 8px; border: 1px solid var(--border); overflow: hidden; background: #f1f5f9; display: flex; align-items: center; justify-content: center;">
                <?php if($cvData && $cvData->photo_path && Storage::disk('public')->exists($cvData->photo_path)): ?>
                  <img src="<?php echo e(asset('storage/' . $cvData->photo_path)); ?>" style="width:100%; height:100%; object-fit:cover;" id="photo-preview-img">
                <?php else: ?>
...
unset($__errorArgs, $__bag); ?>" accept="image/*" onchange="previewPhoto(this)">
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="card shadow-sm" style="border-radius: var(--radius-lg);">
        ...
        <div class="card-body" style="padding: 24px;">
          <div class="form-group">
            <textarea name="objective" class="form-control" rows="4" placeholder="Khát khao học hỏi và mong muốn cống hiến cho công ty..." style="resize: vertical;"><?php echo e(old('objective', $cvData->objective ?? '')); ?></textarea>
      ...
      <div class="card shadow-sm" style="border-radius: var(--radius-lg);">
        ...
        <div class="card-body" style="padding: 24px;">
          <div class="form-group">
            ...
            <textarea name="skills_text" class="form-control" rows="3" placeholder="PHP, Laravel, MySQL, JavaScript, VueJS, Git, Docker, RESTful API..." style="resize: vertical;"><?php echo e(old('skills_text', $cvData->skills_text ?? '')); ?></textarea>
      ...
      <div class="card shadow-sm" style="border-radius: var(--radius-lg);">
        ...
        <div class="card-body" style="padding: 24px;">
          <div id="education-wrapper" class="flex-col gap-16">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $education; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $edu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <div class="repeater-item" style="border: 1px solid var(--border); border-radius: var(--radius); padding: 16px; position: relative; background: #fafafa;">
                ...
                <div class="grid-2 gap-12 mb-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="education[<?php echo e($index); ?>][school]" class="form-control" value="<?php echo e($edu['school'] ?? ''); ?>" placeholder="Đại học Bách Khoa Hà Nội" required>
                  </div>
                  <div class="form-group">
                    <label class="form-label fs-11 mb-4">Ngành học / Bằng cấp</label>
                    <input type="text" name="education[<?php echo e($index); ?>][degree]" class="form-control" value="<?php echo e($edu['degree'] ?? ''); ?>" placeholder="Cử nhân Công nghệ thông tin" required>
                  </div>
                </div>
                <div class="grid-2 gap-12">
                  <div class="form-group">
                    <label class="form-label fs-11 mb-4">Thời gian bắt đầu</label>
                    <input type="text" name="education[<?php echo e($index); ?>][year_start]" class="form-control" value="<?php echo e($edu['year_start'] ?? ''); ?>" placeholder="2018">
                  </div>
                  <div class="form-group">
                    <label class="form-label fs-11 mb-4">Thời gian kết thúc</label>
                    <input type="text" name="education[<?php echo e($index); ?>][year_end]" class="form-control" value="<?php echo e($edu['year_end'] ?? ''); ?>" placeholder="2022 (Hoặc Hiện tại)">
                  </div>
                </div>
              </div>
      ...
      <div class="card shadow-sm" style="border-radius: var(--radius-lg);">
        ...
        <div class="card-body" style="padding: 24px;">
          <div id="experience-wrapper" class="flex-col gap-16">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $experience; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <div class="repeater-item" style="border: 1px solid var(--border); border-radius: var(--radius); padding: 16px; position: relative; background: #fafafa;">
                <button type="button" class="btn-remove" onclick="removeRepeaterRow(this)" style="position: absolute; top: 12px; right: 12px; border: none; background: transparent; color: var(--danger); cursor: pointer;" title="Xóa dòng này">
                  <i class="fas fa-times-circle fa-lg"></i>
                </button>
                <div class="grid-2 gap-12 mb-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="experience[<?php echo e($index); ?>][company]" class="form-control" value="<?php echo e($exp['company'] ?? ''); ?>" placeholder="FPT Software" required>
                  </div>
                  <div class="form-group">
                    <label class="form-label fs-11 mb-4">Vị trí / Chức vụ</label>
                    <input type="text" name="experience[<?php echo e($index); ?>][role]" class="form-control" value="<?php echo e($exp['role'] ?? ''); ?>" placeholder="Lập trình viên Backend PHP" required>
                  </div>
                </div>
                <div class="grid-2 gap-12 mb-12">
                  <div class="form-group">
                    <label class="form-label fs-11 mb-4">Thời gian bắt đầu</label>
                    <input type="text" name="experience[<?php echo e($index); ?>][year_start]" class="form-control" value="<?php echo e($exp['year_start'] ?? ''); ?>" placeholder="06/2023">
                  </div>
                  <div class="form-group">
                    <label class="form-label fs-11 mb-4">Thời gian kết thúc</label>
                    <input type="text" name="experience[<?php echo e($index); ?>][year_end]" class="form-control" value="<?php echo e($exp['year_end'] ?? ''); ?>" placeholder="Hiện tại">
                  </div>
                </div>
                <div class="form-group">
                  <label class="form-label fs-11 mb-4">Mô tả công việc & Thành tích</label>
                  <textarea name="experience[<?php echo e($index); ?>][desc]" class="form-control" rows="3" placeholder="- Xây dựng RESTful API cho dự án mạng xã hội nội bộ.&#10;- Tối ưu hóa truy vấn SQL, giảm thời gian phản hồi API xuống 25%." style="resize:vertical;"><?php echo e($exp['desc'] ?? ''); ?></textarea>
                </div>
              </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
              <div class="repeater-item" style="border: 1px solid var(--border); border-radius: var(--radius); padding: 16px; position: relative; background: #fafafa;">
              ...
              <div class="repeater-item" style="border: 1px solid var(--border); border-radius: var(--radius); padding: 16px; position: relative; background: #fafafa;">
                ...
                <div class="grid-2 gap-12 mb-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="projects[<?php echo e($index); ?>][name]" class="form-control" value="<?php echo e($proj['name'] ?? ''); ?>" placeholder="Website Thương mại Điện tử" required>
                  </div>
                  <div class="form-group">
                    <label class="form-label fs-11 mb-4">Công nghệ sử dụng</label>
                    <input type="text" name="projects[<?php echo e($index); ?>][tech]" class="form-control" value="<?php echo e($proj['tech'] ?? ''); ?>" placeholder="Laravel, VueJS, MySQL, Docker">
                  </div>
                </div>
                <div class="form-group mb-12">
                  <label class="form-label fs-11 mb-4">Đường dẫn dự án / Github</label>
                  <input type="url" name="projects[<?php echo e($index); ?>][url]" class="form-control" value="<?php echo e($proj['url'] ?? ''); ?>" placeholder="https://github.com/nguyenvana/ecommerce">
                </div>
                <div class="form-group">
                  <label class="form-label fs-11 mb-4">Mô tả dự án & Vai trò của bạn</label>
                  <textarea name="projects[<?php echo e($index); ?>][desc]" class="form-control" rows="3" placeholder="Website bán quần áo với đầy đủ tính năng giỏ hàng, thanh toán qua cổng VNPay, quản trị sản phẩm. Vai trò: Fullstack Developer thiết kế database và API thanh toán." style="resize:vertical;"><?php echo e($proj['desc'] ?? ''); ?></textarea>
                </div>
              </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
              <div class="repeater-item" style="border: 1px solid var(--border); border-radius: var(--radius); padding: 16px; position: relative; background: #fafafa;">
      ...
      <div class="card shadow-sm" style="border-radius: var(--radius-lg);">
        ...
        <div class="card-body" style="padding: 24px;">
          <div id="certification-wrapper" class="flex-col gap-16">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $certifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <div class="repeater-item" style="border: 1px solid var(--border); border-radius: var(--radius); padding: 16px; position: relative; background: #fafafa;">
                <button type="button" class="btn-remove" onclick="removeRepeaterRow(this)" style="position: absolute; top: 12px; right: 12px; border: none; background: transparent; color: var(--danger); cursor: pointer;" title="Xóa dòng này">
                  <i class="fas fa-times-circle fa-lg"></i>
                </button>
                <div class="grid gap-12" style="grid-template-columns: 2fr 2fr 1fr;">
                  <div class="form-group">
                    ...
                    <input type="text" name="certifications[<?php echo e($index); ?>][name]" class="form-control" value="<?php echo e($cert['name'] ?? ''); ?>" placeholder="AWS Certified Solutions Architect" required>
                  </div>
                  <div class="form-group">
                    <label class="form-label fs-11 mb-4">Tổ chức cấp</label>
                    <input type="text" name="certifications[<?php echo e($index); ?>][issuer]" class="form-control" value="<?php echo e($cert['issuer'] ?? ''); ?>" placeholder="Amazon Web Services">
                  </div>
                  <div class="form-group">
                    <label class="form-label fs-11 mb-4">Năm nhận</label>
                    <input type="text" name="certifications[<?php echo e($index); ?>][year]" class="form-control" value="<?php echo e($cert['year'] ?? ''); ?>" placeholder="2023">
                  </div>
                </div>
              </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
      ...
      <div class="card shadow-sm" style="border-radius: var(--radius-lg);">
        ...
        <div class="card-body" style="padding: 24px;">
          <div id="language-wrapper" class="flex-col gap-16">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <div class="repeater-item" style="border: 1px solid var(--border); border-radius: var(--radius); padding: 16px; position: relative; background: #fafafa;">
                <button type="button" class="btn-remove" onclick="removeRepeaterRow(this)" style="position: absolute; top: 12px; right: 12px; border: none; background: transparent; color: var(--danger); cursor: pointer;" title="Xóa dòng này">
                  <i class="fas fa-times-circle fa-lg"></i>
                </button>
                <div class="grid-2 gap-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="languages[<?php echo e($index); ?>][lang]" class="form-control" value="<?php echo e($lang['lang'] ?? ''); ?>" placeholder="Tiếng Anh" required>
                  </div>
                  <div class="form-group">
                    <label class="form-label fs-11 mb-4">Trình độ / Chứng chỉ</label>
                    <input type="text" name="languages[<?php echo e($index); ?>][level]" class="form-control" value="<?php echo e($lang['level'] ?? ''); ?>" placeholder="IELTS 7.0 / Giao tiếp trôi chảy" required>
                  </div>
                </div>
              </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
      ...
      <div class="card shadow-sm" style="border-radius: var(--radius-lg); border-top: 3px solid #1a73e8;">
        ...
        <div class="card-body" style="padding: 20px;">
          <div class="form-group mb-16">
            ...
            <select name="template" class="form-control <?php $__errorArgs = ['template'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required style="cursor: pointer;">
              <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($tpl); ?>" <?php echo e(old('template', $cvData->template ?? 'default') === $tpl ? 'selected' : ''); ?>>
                  Mẫu <?php echo e(ucfirst($tpl)); ?>
...
let counters = {
  education: <?php echo e(count($education) > 0 ? count($education) : 1); ?>,
  experience: <?php echo e(count($experience) > 0 ? count($experience) : 1); ?>,
  projects: <?php echo e(count($projects) > 0 ? count($projects) : 1); ?>,
  certifications: <?php echo e(count($certifications) > 0 ? count($certifications) : 1); ?>,
  languages: <?php echo e(count($languages) > 0 ? count($languages) : 1); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\web_timviec_final\website_timviec\resources\views/user/create-cv.blade.php ENDPATH**/ ?>