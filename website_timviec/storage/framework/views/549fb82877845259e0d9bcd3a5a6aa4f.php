<?php $__env->startSection('title', 'Dashboard — Ứng viên'); ?>
...
.job-icon {
  ...
  background: #f0fdf7; border-radius: 10px;
  display: flex; align-items: center; justify-content: center;
...
<div class="hero-greeting">
  ...
  <a href="<?php echo e(url('/job')); ?>" class="btn-white"><i class="fas fa-search" style="margin-right:6px"></i>Tìm việc ngay</a>
</div>
...
<div style="background:#fffbeb;border:1px solid #fcd34d;border-radius:12px;padding:14px 20px;display:flex;align-items:center;gap:12px;margin-bottom:20px">
  ...
  <span style="font-size:14px;color:#92400e">Hồ sơ chưa có CV! Hãy <a href="<?php echo e(url('/user/cv')); ?>" style="color:#d97706;font-weight:700;text-decoration:underline">tải lên CV hoặc tạo CV online</a> để ứng tuyển ngay.</span>
</div>
<?php endif; ?>
...
<div class="stat-grid">
  <div class="stat-box">
    ...
    <div>
      <div class="stat-box__num"><?php echo e($appliedJobs ? $appliedJobs->count() : 0); ?></div>
  ...
  <div class="stat-box">
    ...
    <div>
      <div class="stat-box__num"><?php echo e($appliedJobs ? $appliedJobs->where('pivot.shortlisted', true)->count() : 0); ?></div>
  ...
  <div class="stat-box">
    ...
    <div>
      <div class="stat-box__num"><?php echo e(auth()->user()->resume ? 1 : 0); ?></div>
...
<div class="main-grid">
  ...
  <div class="section-card">
    <div class="section-card__header">
      ...
      <a href="<?php echo e(url('/applicants')); ?>" style="font-size:13px;color:#10b981;font-weight:600;text-decoration:none">Xem tất cả →</a>
    </div>
    <?php $__empty_1 = true; $__currentLoopData = $appliedJobs ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
      <div class="job-item">
        ...
        <div style="flex:1;min-width:0">
          <div class="job-title"><a href="<?php echo e(url('/job/show/'.$job->slug)); ?>" style="color:#1e293b;text-decoration:none"><?php echo e(Str::limit($job->title, 40)); ?></a></div>
          <div class="job-company"><?php echo e($job->user->company_name ?? $job->user->name); ?></div>
        </div>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
      <div class="empty-state">
        ...
        <p>Bạn chưa nộp đơn vào công việc nào.<br><a href="<?php echo e(url('/job')); ?>" style="color:#10b981;font-weight:600">Tìm việc ngay →</a></p>
      </div>
    <?php endif; ?>
  </div>
  ...
  <div style="display:flex;flex-direction:column;gap:16px">
    ...
    <div class="section-card">
      ...
      <div style="padding:14px">
        <a href="<?php echo e(url('/user/cv/create')); ?>" class="quick-btn quick-btn-primary"><i class="fas fa-magic"></i> Tạo CV online mới</a>
        <a href="<?php echo e(url('/user/cv')); ?>"        class="quick-btn"><i class="fas fa-upload"></i> Quản lý & Tải lên CV</a>
        <a href="<?php echo e(url('/job')); ?>"            class="quick-btn"><i class="fas fa-search"></i> Tìm kiếm việc làm IT</a>
        <a href="<?php echo e(url('/messages')); ?>"       class="quick-btn"><i class="fas fa-comment-dots"></i> Hộp thư trao đổi</a>
      </div>
    </div>
    ...
    <div class="section-card">
      ...
      <div style="padding:16px">
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;font-size:13px;font-weight:700">
          <span style="color:#1e293b"><?php echo e($score); ?>% hoàn thành</span>
          <?php if($score < 100): ?>
            <a href="<?php echo e(url('/user/profile')); ?>" style="color:#10b981;font-size:12px">Cải thiện →</a>
          <?php else: ?>
            <span style="color:#10b981">🎉 Đầy đủ!</span>
          <?php endif; ?>
        </div>
        <div class="progress-wrap"><div class="progress-bar" style="width:<?php echo e($score); ?>%"></div></div>
        <div>
          <div class="check-item <?php echo e(auth()->user()->name ? 'done' : 'todo'); ?>">
            <i class="fas <?php echo e(auth()->user()->name ? 'fa-check-circle' : 'fa-circle'); ?>"></i> Tên hiển thị cá nhân
          </div>
          <div class="check-item <?php echo e(auth()->user()->about ? 'done' : 'todo'); ?>">
            <i class="fas <?php echo e(auth()->user()->about ? 'fa-check-circle' : 'fa-circle'); ?>"></i> Thông tin giới thiệu ngắn
          </div>
          <div class="check-item <?php echo e(auth()->user()->profile_pic ? 'done' : 'todo'); ?>">
            <i class="fas <?php echo e(auth()->user()->profile_pic ? 'fa-check-circle' : 'fa-circle'); ?>"></i> Ảnh chân dung đại diện
          </div>
          <div class="check-item <?php echo e((auth()->user()->resume || auth()->user()->cvData) ? 'done' : 'todo'); ?>">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\dl\website_timviec_v13_social_verified\website_output\resources\views/dashboard/employee.blade.php ENDPATH**/ ?>