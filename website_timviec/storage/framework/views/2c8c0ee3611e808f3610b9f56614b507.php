<?php $__env->startSection('title', 'Tin đăng của tôi'); ?>
...
<?php if(!$isPremium): ?>
  <div style="background:linear-gradient(135deg,#fff7ed,#fffbeb);border:1px solid #fcd34d;border-radius:12px;padding:14px 20px;margin-bottom:20px;display:flex;align-items:center;justify-content:space-between;gap:16px">
    <div style="display:flex;align-items:center;gap:12px">
      ...
      <div>
        <span class="fw-600 fs-14" style="color:#92400e">Tài khoản Free — Đã dùng <?php echo e($postCount); ?>/<?php echo e($freeLimit); ?> lượt đăng tin tháng này</span>
    ...
    <a href="<?php echo e(route('payment.subscription')); ?>" class="btn btn-sm" style="background:#f59e0b;color:#fff;white-space:nowrap;flex-shrink:0">
    ...
    <table class="table">
      ...
      <tbody>
        <?php $__currentLoopData = $listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            <td>
              <a href="<?php echo e(url('/job/show/'.$listing->slug)); ?>" class="fw-600 fs-13" style="color:var(--secondary)" target="_blank">
                <?php echo e(Str::limit($listing->title, 40)); ?>

              </a>
            </td>
            <td><span class="tag tag-blue fs-12"><?php echo e($listing->address); ?></span></td>
            <td class="fw-600 text-primary-color fs-13">
              <?php echo e($listing->salary == 0 ? 'Thỏa thuận' : number_format($listing->salary).'đ'); ?>

            </td>
            <td>
              <a href="<?php echo e(route('employer.applicants', $listing->id)); ?>" class="flex gap-4" style="align-items:center;color:var(--text-secondary);font-size:13px">
                <i class="fas fa-users" style="color:var(--primary)"></i>
                <span class="fw-700" style="color:var(--primary)"><?php echo e($listing->applications_count); ?></span> người
              </a>
            </td>
            <td class="fs-13 text-muted"><?php echo e(\Carbon\Carbon::parse($listing->application_close_date)->format('d/m/Y')); ?></td>
            <td>
            ...
            <td>
              <div class="flex gap-6">
                <a href="<?php echo e(url('/job/'.$listing->id.'/edit')); ?>" class="btn btn-outline btn-sm" title="Chỉnh sửa"><i class="fas fa-edit"></i></a>
                <a href="<?php echo e(route('employer.applicants', $listing->id)); ?>" class="btn btn-primary btn-sm" title="Xem ứng viên"><i class="fas fa-users"></i></a>
...
<div id="quota-modal" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9999;align-items:center;justify-content:center">
  <div style="background:#fff;border-radius:20px;padding:40px 36px;max-width:460px;width:90%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.2)">
    ...
    <p class="text-muted fs-14" style="line-height:1.7;margin-bottom:24px">
      Tài khoản Free chỉ cho phép đăng <strong>3 tin/tháng</strong>. Bạn đã dùng <strong><?php echo e($postCount); ?>/<?php echo e($freeLimit); ?></strong> lượt.<br><br>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\web_timviec_fixed\web_timviec_fixed\website_timviec\resources\views/job/manage.blade.php ENDPATH**/ ?>