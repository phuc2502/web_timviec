...
<div class="container section" style="max-width:860px">
  ...
  <?php if($status['has_active']): ?>
    <div class="alert alert-success mb-24" style="display:flex;align-items:center;justify-content:space-between">
      <div>
        <strong><i class="fas fa-check-circle fa-fw"></i> Đang dùng gói: <?php echo e(ucfirst($status['plan'])); ?></strong>
        <div class="fs-13 mt-8">Hết hạn: <strong><?php echo e($status['billing_ends']); ?></strong> · Còn <strong><?php echo e($status['days_remaining']); ?> ngày</strong></div>
      </div>
      <a href="<?php echo e(route('employer.subscription.status')); ?>" class="btn btn-outline btn-sm">Xem chi tiết</a>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\web_timviec_fixed\web_timviec_fixed\website_timviec\resources\views/payment/subscription.blade.php ENDPATH**/ ?>