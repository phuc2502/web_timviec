<?php $__env->startSection('title', 'Đăng ký — ITWorks'); ?>
...
<div class="reg-page">
  <div class="reg-wrap">
    ...
    <div class="text-center" style="margin-bottom:32px">
      ...
      <h1 style="font-size:22px;font-weight:800;margin:16px 0 6px;color:#1e293b">Bạn muốn đăng ký với tư cách nào?</h1>
      <p style="font-size:14px;color:#94a3b8;margin:0">Chọn loại tài khoản phù hợp — có thể thay đổi sau</p>
    </div>
    ...
    <div class="role-grid">
      ...
      <a href="<?php echo e(route('register.employee')); ?>" class="role-card role-card-employee" id="card-employee">
      ...
      <a href="<?php echo e(route('register.employer')); ?>" class="role-card role-card-employer" id="card-employer">
    ...
    <div class="social-section" style="text-align:center;padding:20px 28px">
...
.role-card__badge {
  ...
  background: #f0fdf7; color: #10b981;
...
.role-card__list li i { color: #10b981; font-size: 12px; flex-shrink: 0; }
.role-card__cta {
  display: flex; align-items: center; justify-content: center;
...
.social-section__label::before {
  content: ''; position: absolute; top: 50%; left: 0; right: 0;
  height: 1px; background: #f1f5f9;
}
.social-section__label span, .social-section__label {
...
.social-google {
  background: #fff; border-color: #e2e8f0; color: #3c4043;
}
.social-google:hover { border-color: #4285F4; background: #f8f9ff; box-shadow: 0 2px 12px rgba(66,133,244,.15); text-decoration: none; color: #3c4043; }
.social-github {
  background: #1a1f24; border-color: #1a1f24; color: #fff;
}
.social-github:hover { background: #0d1117; border-color: #0d1117; box-shadow: 0 2px 12px rgba(0,0,0,.2); text-decoration: none; color: #fff; }
</style>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\dl\website_timviec_v15 (1)\website_timviec_v15 (1)\website_modified\resources\views/auth/register.blade.php ENDPATH**/ ?>