...
<div class="wrapper">
  <div class="container">
    ...
    <div class="body">
      <p class="greeting greeting-employer">Xin chào, <?php echo e($user->name); ?>!</p>
      ...
      <div class="info-box info-box-employer">
        <p><strong class="label-employer">Email:</strong> <?php echo e($user->email); ?></p>
        <p><strong class="label-employer">Loại tài khoản:</strong> Nhà tuyển dụng</p>
        <?php if($user->company_name): ?>
        <p><strong class="label-employer">Công ty:</strong> <?php echo e($user->company_name); ?></p>
        <?php endif; ?>
        <p><strong class="label-employer">Đăng ký lúc:</strong> <?php echo e(\Carbon\Carbon::now('Asia/Ho_Chi_Minh')->format('d/m/Y H:i')); ?> (Giờ VN)</p>
        <?php if($user->user_trial): ?>
        <p><strong class="label-employer">🎁 Dùng thử miễn phí đến:</strong> <?php echo e(\Carbon\Carbon::parse($user->user_trial)->timezone('Asia/Ho_Chi_Minh')->format('d/m/Y')); ?></p>
        <?php endif; ?>
      </div>
      ...
      <div class="btn-wrapper">
        <a href="<?php echo e(url('/')); ?>" class="btn-employer">Vào trang tuyển dụng →</a>
      </div>
    ...
    <div class="body">
      <p class="greeting greeting-employee">Xin chào, <?php echo e($user->name); ?>!</p>
      ...
      <div class="info-box">
        <p><strong class="label-employee">Email:</strong> <?php echo e($user->email); ?></p>
        <p><strong class="label-employee">Loại tài khoản:</strong> Ứng viên</p>
        <p><strong class="label-employee">Đăng ký lúc:</strong> <?php echo e(\Carbon\Carbon::now('Asia/Ho_Chi_Minh')->format('d/m/Y H:i')); ?> (Giờ VN)</p>
      </div>
      <div class="feature-list">
      ...
      <div class="btn-wrapper">
        <a href="<?php echo e(url('/')); ?>" class="btn-employee">Vào trang tuyển dụng →</a>
      </div>
    <?php endif; ?>
    ...
    <div class="footer">
      <p>© <?php echo e(date('Y')); ?> ITWorks. All rights reserved.</p>
...
<?php /**PATH F:\dl\website_timviec_v15 (1)\website_timviec_v15 (1)\website_timviec\resources\views/emails/welcome.blade.php ENDPATH**/ ?>