          ...
          <tr>
            <td style="padding:40px 40px 32px">
              ...
              <p style="margin:0 0 12px;color:#475569;font-size:15px;line-height:1.6">
                Xin chào <strong><?php echo e($notifiable->name); ?></strong>,
              </p>
              ...
              <p style="margin:0 0 28px;word-break:break-all">
                <a href="<?php echo e($verificationUrl); ?>" style="color:#10b981;font-size:12px"><?php echo e($verificationUrl); ?></a>
              </p>
          ...
          <tr>
            <td style="background:#f8fafc;padding:20px 40px;text-align:center;border-top:1px solid #f1f5f9">
              <p style="margin:0;color:#94a3b8;font-size:12px">
                © <?php echo e(date('Y')); ?> ITWorks — Nền tảng tuyển dụng IT hàng đầu Việt Nam
              </p>
            </td>
          </tr>
...
<?php /**PATH F:\dl\website_timviec_v15 (1)\website_timviec_v15 (1)\website_modified\resources\views/emails/verify-email.blade.php ENDPATH**/ ?>