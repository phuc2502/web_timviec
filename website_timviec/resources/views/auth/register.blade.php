...
<div class="reg-page">
  <div class="reg-wrap">
    ...
    <div class="text-center" style="margin-bottom:32px">
      <a href="{{ url('/') }}" class="navbar-brand" style="font-size:32px;justify-content:center">IT<span>Works</span></a>
    ...
    <div class="role-grid">
      ...
      {{-- ỨNG VIÊN --}}
      <a href="{{ route('register.employee') }}" class="role-card role-card-employee" id="card-employee">
    ...
    <div class="social-section" style="text-align:center;padding:20px 28px">
      <p style="font-size:14px;color:#94a3b8;margin:0">
        Đã có tài khoản? <a href="{{ route('login') }}" style="color:#10b981;font-weight:700">Đăng nhập ngay →</a>
      </p>
    </div>
