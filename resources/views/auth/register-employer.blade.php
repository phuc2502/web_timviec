@extends('layouts.app')
@section('title', 'Đăng ký Nhà tuyển dụng — ITWorks')
  ...
  <div class="auth-container" style="max-width:520px">
    ...
    <div class="card auth-card">
      <div class="card-body" style="padding:28px">
        ...
        <form action="{{ route('register.employer.submit') }}" method="POST" id="register-form">
          @csrf
          <div style="display:flex;flex-direction:column;gap:14px">
            ...
            <div class="form-group">
              ...
              <div class="input-icon-wrap">
                ...
                <input type="text" name="company_name"
                  class="form-control input-with-icon {{ $errors->has('company_name') ? 'is-invalid' : '' }}"
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:4px">
              <a href="{{ route('auth.google.register', 'employer') }}" class="btn btn-google" style="justify-content:center">
              ...
              <a href="{{ route('auth.github.register', 'employer') }}" class="btn" style="
                display:flex;align-items:center;justify-content:center;gap:8px;
