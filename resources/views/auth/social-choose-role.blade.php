@extends('layouts.app')
@section('title', 'Chọn vai trò — ITWorks')
...
<div class="reg-page">
  <div class="reg-wrap">
    ...
    <div class="text-center" style="margin-bottom:32px">
      ...
      <p style="font-size:14px;color:#94a3b8;margin:0">Chọn vai trò phù hợp để hoàn tất đăng ký qua <strong>{{ $provider === 'github' ? 'GitHub' : 'Google' }}</strong></p>
    </div>
    ...
    <div class="role-grid">
      ...
      {{-- ỨNG VIÊN --}}
      <a href="{{ route('auth.social.role', ['provider' => $provider, 'role' => 'employee']) }}" class="role-card role-card-employee">
      ...
      {{-- NHÀ TUYỂN DỤNG --}}
      <a href="{{ route('auth.social.role', ['provider' => $provider, 'role' => 'employer']) }}" class="role-card role-card-employer">
