@extends('layouts.app')
@section('title', 'Đăng nhập — ITWorks')
...
<div class="auth-page">
  <div class="auth-container">
    ...
    <div class="auth-card">
      ...
      {{-- Flash --}}
      @if(session('success'))
        <div class="auth-alert auth-alert-success"><i class="fas fa-check-circle"></i> {{ session('success') }}</div>
      @endif
      @if(session('info'))
        <div class="auth-alert auth-alert-info"><i class="fas fa-info-circle"></i> {{ session('info') }}</div>
      @endif
      ...
      <form action="{{ route('login') }}" method="POST" id="login-form">
        ...
        <div class="form-group">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px">
            ...
            <a href="{{ route('password.request') }}" style="font-size:12px;color:var(--primary)">Quên mật khẩu?</a>
          </div>
          <div class="input-wrap">
        ...
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:20px">
          <input type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }} style="width:16px;height:16px;accent-color:var(--primary)">
      ...
      <div class="social-row">
        ...
        <a href="{{ route('auth.github') }}" class="social-btn social-btn-github">
      ...
      <div class="auth-footer">
        ...
        <a href="{{ route('register') }}" style="color:var(--primary);font-weight:700;margin-left:6px">Đăng ký ngay →</a>
      </div>
    </div>
...
@push('styles')
<style>
:root { --primary:#00C16A; --primary-dark:#009E55; }
.auth-page {
