  ...
  <div style="width:100%;max-width:520px;margin:0 auto">
    ...
    <div class="card">
      <div class="card-body" style="padding:28px">
        ...
        <form action="{{ url('/register/employer') }}" method="POST">
          @csrf
          ...
          <div class="flex-col gap-14">
            ...
            <div class="form-group">
              ...
              <input type="text" name="company_name" class="form-control {{ $errors->has('company_name') ? 'is-invalid' : '' }}"
                placeholder="VD: FPT Software, VNG Corporation..." value="{{ old('company_name') }}">
      ...
      <div class="card-footer text-center">
        <a href="{{ url('/register') }}" class="fs-12 text-muted"><i class="fas fa-arrow-left"></i> Chọn lại</a>
