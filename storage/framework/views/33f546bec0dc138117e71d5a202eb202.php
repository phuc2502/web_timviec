      ...
      <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr>
          ...
          <td>
            ...
            ?>
            <span style="font-size:11px; font-weight:600; padding:3px 10px; border-radius:5px; background:<?php echo e($r['bg']); ?>; color:<?php echo e($r['color']); ?>"><?php echo e($r['label']); ?></span>
          </td>
          <td>
          ...
          <td>
            ...
            ?>
            <span style="font-size:11px; font-weight:600; padding:3px 10px; border-radius:5px; background:<?php echo e($p['bg']); ?>; color:<?php echo e($p['color']); ?>"><?php echo e($p['label']); ?></span>
          </td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\dl\web_timviec_updated\web_timviec\resources\views/admin/users.blade.php ENDPATH**/ ?>