<?php $__env->startSection('title', 'Duyệt Tin Tuyển Dụng'); ?>
...
<div class="flex-between mb-20">
  <div>
    ...
    <p class="text-muted fs-13 mt-2">
      Có <strong style="color:#ef4444;"><?php echo e($pendingCount); ?></strong> tin đang chờ duyệt trong hệ thống
    </p>
  </div>

  
  <form action="<?php echo e(url('/admin/jobs/pending')); ?>" method="GET">
    <div style="display:flex; gap:8px; align-items:center;">
      ...
      <select name="job_type" class="form-control" style="width:140px; font-size:13px; cursor:pointer;">
        ...
        <option value="internship" <?php echo e(request('job_type') === 'internship' ? 'selected' : ''); ?>>Thực tập</option>
      </select>

      <button type="submit" class="btn btn-primary btn-sm" style="padding:0 14px; height:38px;">
        <i class="fas fa-search"></i> Lọc
      </button>
      <?php if(request()->anyFilled(['search','job_type'])): ?>
        <a href="<?php echo e(url('/admin/jobs/pending')); ?>" class="btn btn-light btn-sm" style="height:38px; padding:0 12px;">
...
<?php $__empty_1 = true; $__currentLoopData = $listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
  <div class="pending-card" id="card-<?php echo e($job->id); ?>"
      ...
      <div style="flex:1; min-width:0;">
        <div style="display:flex; align-items:flex-start; justify-content:space-between; gap:12px; flex-wrap:wrap;">
          <div>
            ...
            <div style="display:flex; gap:6px; flex-wrap:wrap;">
              ...
              ?>
              <span style="font-size:10px; font-weight:700; padding:2px 9px; border-radius:5px; background:<?php echo e($tc['bg']); ?>; color:<?php echo e($tc['color']); ?>;">
                <?php echo e($tc['label']); ?>
              ...
              <?php if($job->application_close_date): ?>
                <?php $expired = \Carbon\Carbon::parse($job->application_close_date)->isPast(); ?>
                <span style="font-size:10px; font-weight:600; padding:2px 9px; border-radius:5px; background:<?php echo e($expired ? '#fef2f2' : '#f0fdf4'); ?>; color:<?php echo e($expired ? '#ef4444' : '#16a34a'); ?>;">
                  <i class="fas fa-calendar" style="margin-right:3px;"></i>
                  Hạn: <?php echo e(\Carbon\Carbon::parse($job->application_close_date)->format('d/m/Y')); ?>

                  <?php echo e($expired ? '(Hết hạn)' : ''); ?>

                </span>
              <?php endif; ?>
              <span style="font-size:10px; color:#94a3b8; padding:2px 0;">
                Đăng <?php echo e($job->created_at->diffForHumans()); ?>
          ...
          <button onclick="openPreviewModal(<?php echo e($job->id); ?>)"
        ...
        <?php if($job->predes): ?>
          <div style="margin-top:12px; padding:10px 14px; background:#f8fafc; border-radius:8px; font-size:12px; color:#475569; line-height:1.6; border-left:3px solid #cbd5e1;">
            <?php echo e(\Illuminate\Support\Str::limit(strip_tags($job->predes), 180)); ?>
        ...
        <div style="display:flex; gap:10px; margin-top:14px; align-items:center; flex-wrap:wrap;">
          ...
          <form action="<?php echo e(url('/admin/jobs/'.$job->id.'/approve')); ?>" method="POST" style="margin:0;">
            <?php echo csrf_field(); ?>
            <button type="submit"
          ...
          <button onclick="openRejectModal(<?php echo e($job->id); ?>, '<?php echo e(addslashes($job->title)); ?>')"
          ...
          <form action="<?php echo e(url('/admin/jobs/'.$job->id)); ?>" method="POST" style="margin:0;"
            onsubmit="return confirm('Xóa vĩnh viễn tin \"<?php echo e(addslashes($job->title)); ?>\"?\nKhông thể hoàn tác!')">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
  <div style="background:#fff; border:1px dashed #e2e8f0; border-radius:14px; padding:60px; text-align:center;">
    ...
    <p style="font-size:13px; color:#94a3b8; margin:0;">Tất cả tin tuyển dụng đã được xử lý. Bạn có thể xem toàn bộ tin tại
      <a href="<?php echo e(url('/admin/jobs')); ?>" style="color:var(--primary); font-weight:600;">Quản lý tin tuyển dụng</a>.
    </p>
  </div>
<?php endif; ?>
  ...
  <div class="card-footer" style="background:#fff; border:1px solid var(--border); border-radius:10px; padding:14px 20px; margin-top:8px;">
    <div class="flex-between">
      <span class="text-muted fs-13">
        Đang xem <?php echo e($listings->firstItem()); ?>–<?php echo e($listings->lastItem()); ?> trong <?php echo e($listings->total()); ?> tin chờ duyệt
      </span>
...
<script>
const ADMIN_JOBS_URL = '<?php echo e(url("/admin/jobs")); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\dl\web_timviec_updated\web_timviec\resources\views/admin/pending-jobs.blade.php ENDPATH**/ ?>