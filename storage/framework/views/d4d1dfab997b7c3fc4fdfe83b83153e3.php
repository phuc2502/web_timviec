  ...
  <div class="container navbar-inner">
    ...
    <div class="navbar-nav">
      ...
      <?php if(auth()->guard()->check()): ?>
        <?php if(auth()->user()->user_type === 'admin' || auth()->user()->is_admin): ?>
          <a href="<?php echo e(url('/admin')); ?>" class="<?php echo e(request()->is('admin') ? 'active' : ''); ?>">Trang quản trị (Admin)</a>
          <a href="<?php echo e(url('/admin/users')); ?>">Quản lý thành viên</a>
          <a href="<?php echo e(url('/admin/jobs')); ?>">Quản lý tin đăng</a>
          <a href="<?php echo e(url('/admin/transactions')); ?>">Lịch sử giao dịch</a>
        <?php elseif(auth()->user()->user_type === 'employer'): ?>
        ...
        <div class="flex gap-8" style="align-items:center">
          ...
          <div style="position:relative;cursor:pointer" onclick="toggleDropdown()">
            ...
            <div id="user-dropdown" style="display:none;position:absolute;right:0;top:40px;background:#fff;border:1px solid var(--border);border-radius:var(--radius-lg);box-shadow:var(--shadow-lg);min-width:180px;z-index:200;overflow:hidden">
              ...
              <?php if(auth()->user()->user_type === 'admin' || auth()->user()->is_admin): ?>
                <a href="<?php echo e(url('/admin')); ?>" style="display:flex;align-items:center;gap:8px;padding:10px 16px;font-size:14px;color:var(--text-secondary);transition:var(--transition)" onmouseover="this.style.background='var(--primary-light)'" onmouseout="this.style.background=''">
    ...
    <div class="grid-4" style="grid-template-columns:2fr 1fr 1fr 1fr">
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="<?php echo e(route('payment.subscription')); ?>">Gói premium</a></li>
        </ul>
      </div>
      <div>
        <h4>Hỗ trợ</h4>
...
<?php /**PATH F:\dl\web_timviec-main (3)\web_timviec-main\resources\views/layouts/app.blade.php ENDPATH**/ ?>