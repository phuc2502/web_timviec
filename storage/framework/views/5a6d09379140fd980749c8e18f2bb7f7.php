          ...
          <div class="flex gap-10" style="align-items:center;flex-wrap:wrap">
            <?php if(auth()->guard()->check()): ?>
              <?php if(auth()->user()->user_type === 'employee'): ?>
                <?php if($applicantLimitReached && !$existingApplication): ?>
                ...
                <?php elseif($isStatusLocked ?? false): ?>
                  ...
                  ?>
                  <div style="background:<?php echo e($lockedBg); ?>;border:1.5px solid <?php echo e($lockedBorder); ?>;border-radius:10px;padding:12px 16px;display:flex;align-items:center;gap:10px">
                    <i class="fas <?php echo e($lockedIcon); ?>" style="color:<?php echo e($lockedColor); ?>;font-size:18px;flex-shrink:0"></i>
                    <div>
                      <div class="fw-600 fs-13" style="color:<?php echo e($lockedColor); ?>">Hồ sơ đang ở trạng thái: <?php echo e($lockedLabel); ?></div>
                ...
                <?php elseif($reapplyDisabled): ?>
                  ...
                  <div style="background:#F5F5F5;border:1.5px solid #D9D9D9;border-radius:10px;padding:12px 16px;display:flex;align-items:center;gap:10px">
                    ...
                    <div>
                      <div class="fw-600 fs-13" style="color:#595959">Đã ứng tuyển tối đa <?php echo e(\App\Models\Application::MAX_APPLY_ROUNDS); ?> lần</div>
                ...
                <?php elseif($existingApplication): ?>
                  <a href="<?php echo e(route('apply.form', ['listingId' => $listing->id])); ?>" class="btn btn-outline btn-lg">
                    <i class="fas fa-redo fa-fw"></i> Ứng tuyển lại
                    <?php if($applyCount > 0): ?>
                      <span style="font-size:11px;font-weight:600;background:var(--primary);color:#fff;border-radius:20px;padding:1px 7px;margin-left:4px"><?php echo e($applyCount); ?>/<?php echo e(\App\Models\Application::MAX_APPLY_ROUNDS); ?></span>
                    <?php endif; ?>
                  </a>
                <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\dl\web_timviec_updated\web_timviec\resources\views/job/show.blade.php ENDPATH**/ ?>